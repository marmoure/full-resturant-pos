    ...
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-900">Grill View</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-xl shadow-sm p-8 border border-slate-200 text-center">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mb-2">Grill Station</h2>
          <p className="text-slate-600 mb-6">
            View and manage grill orders in real-time. Coming soon!
          </p>
